...
class CellGroup {
  public:
    ...
    std::vector<long long> output_gid;     // n_presyn of these, -(type + 1000*index) if no gid
    std::vector<long long> output_vindex;  // n_presyn of these. >=0 if associated with voltage,
